...
export type FileUploaderResult = {
  ...
  cancel: () => void;
  /** The selected file */
  selectedFile: File | null; // Added selectedFile
};
 ...
 * - selectedFile: The uploaded File object
 */
export const useFileUploader = (): FileUploaderResult => {
  ...
  const processFile = (file: File) => {
    setSelectedFile(file); // Track the selected file
  ...
  return {
    ...
    cancel,
    selectedFile, // Include selectedFile in returned object
  };
};
